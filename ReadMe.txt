...
2. ASP.NET Core 3.1 Web Application (MVC) projesi eklenir.
	...
	2.1. Views->Home klasorunun icindeki Index view'a request aticagimiz api için ajax ile Get() fonksiyonu yazilir ve gelen verileri dolduracaðýmýz html kodlari yazilir.
...
Projenin amacý : https://newsapi.org/ adresinden hazirlanmis olan api'lerden birine request atarak datalari "get" etmek ve bu iþlemi ajax yöntemiyle gerçekleþtiriyoruz.